...
/**
 * Generated class for the ShowstationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-showstation',
  templateUrl: 'showstation.html',
})
export class ShowstationPage {
  ...
  showData() {
    ...
    console.log(data)
    this.http.post('https://sunholidaystyle.com/api/train/station', data, options)
      .map(res => res.json())
      .subscribe(res => {
        //console.log(res)
